...
This web app scrapes the runtime environment variables for each variant of Proton from their respective README files on a daily schedule. It then allows you to compare and explore those environment variables.

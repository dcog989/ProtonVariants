...
<section class="space-y-3 text-sm text-neutral-700 dark:text-neutral-300">
  <p>
    Proton is Valve's Steam compatibility layer, along with community forks like GloriousEggroll's
    Proton GE and CachyOS Proton. Each ships a set of runtime environment variables you can use to
    tweak game behavior. Proton Variants collects those variables from every variant's README,
    parses them at build time, and republishes them here as a static site — regenerated daily via CI
